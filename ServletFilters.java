...
/* loaded from: ServletFilters.class */
enum ServletFilters {
    ...
    HIBERNATE_GET_CONNECTION_FILTER(ServletFilterRegistrar.filter("hibernate-get-connection", new HibernateGetConnectionFilter()).mapping(DispatcherType.ERROR, new UrlPattern[]{UrlPattern.ERROR_500_JSP})),
    ...
    OPEN_TENANT_GATE_FILTER(ServletFilterRegistrar.filter("OpenTenantGateFilter", new TenantGateFilter()).initParam("permit", "true").mapping(new UrlPattern[]{UrlPattern.ADMIN_APP_TRUST_CERTIFICATE, UrlPattern.SETUP, UrlPattern.BOOTSTRAP, UrlPattern.JOHNSON, UrlPattern.ERRORS_JSP})),
    PLUGIN_FILTERS_AFTER_ENCODING((ServletContextRegistrar) PluginFilterLocation.AFTER_ENCODING),
    ...
    PLUGIN_FILTERS_BEFORE_LOGIN((ServletContextRegistrar) PluginFilterLocation.BEFORE_LOGIN),
    ...
    PLUGIN_FILTERS_BEFORE_DECORATION((ServletContextRegistrar) PluginFilterLocation.BEFORE_DECORATION),
    ...
    PLUGIN_FILTERS_BEFORE_DISPATCH((ServletContextRegistrar) PluginFilterLocation.BEFORE_DISPATCH),
    ...
    ServletFilters(ServletContextRegistrar registrar) {
